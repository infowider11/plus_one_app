...
class Event_Recover_Page extends StatefulWidget {
  const Event_Recover_Page({Key? key}) : super(key: key);

  @override
  State<Event_Recover_Page> createState() => _Event_Recover_PageState();
}
bool post = true;
bool list = false;
class _Event_Recover_PageState extends State<Event_Recover_Page> {
            ...
            GestureDetector(
                onTap: (){
                    showCustomDialogBox(context: context,
                        ...
                        child: Column(
                          children: [
                            MainHeadingText(text: 'Add Message (Optional)', fontSize: 20,),
                            vSizedBox2,
                            // Container(
                ...
                child:  Column(
                  ...
                  children: [
                    Image.asset(MyImages.unlock, height: 30,),
                  ],
                )
            ),
            hSizedBox,
