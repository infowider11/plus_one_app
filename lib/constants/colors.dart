...
class MyColors{
  static const Color primaryColor = Color(0xFFfca071);
  static const Color secondarycolor = Color(0xFF959292);
  ...
  static const Color headingcolor = Color(0xFF100f0f);
  static const Color paragraphcolor = Color(0xFF100f0f);
  ...
  static const Color fadeprimary = Color(0xffffb28b);
  static const Color popupbackground = Color(0xffd6d5d5);
}