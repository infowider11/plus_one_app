...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SplashScreenPage(),//Welcome_Page(),
      builder: EasyLoading.init(),
      // home: Profile_After_Signup(),
    );
  }
}
